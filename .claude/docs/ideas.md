...
### Community Sharing — CLI Install Command
- 날짜: 2026-04-09
- 출처: later.md
- 배경: 서버 RAG 외에 GitHub 레포(dotclaude-community) 기반 가벼운 공유 경로도 필요
- 개요: `dotclaude install <name>` 으로 커뮤니티 rules/agents/skills 설치. Phase 1은 GitHub 레포, Phase 2-3은 서버 연동
- 상태: Phase 1 이후 검토
